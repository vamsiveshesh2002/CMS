...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="Image.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
...
<br>
      <div class="card" style="width: 20rem;">
        <img class="card-img-top" src="dp.jpg" alt="Card image cap">
        <div class="card-body">
            ...
            <div class="card">
              ...
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body">
                      ...
                      <?php echo isset($student['email']); ?></li>
                      <li class="list-group-item"><?php echo $student['birthdate']; ?></li>
                      <li class="list-group-item"><?php echo $student['department']; ?></li>
                      <li class="list-group-item"><?php echo $student['scholarship']; echo " | "; echo isset($student['degree']);?></li>
                ...
                <div class="card-body">
                  <ul class="list-group list-group-flush">
                    ...
                    <?php 
                      ...
                      while($club = mysqli_fetch_array($results2)){   
                       ?>
