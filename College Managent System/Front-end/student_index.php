...
<html lang="en">
  <head>
    ...
    <title>VIT-AP</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" href="Image.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
...
.carousel-item>a>img::after {
    box-shadow: 10px 20px 60px 40px black inset;
    bottom: 0;
    content: "";
    display: block;
    left: 0;
    ...
    <script src="im.js" crossorigin="anonymous"></script>
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="attd_view.php">Attendance</a>
            </li>
          </ul>
        ...
        <form method="post" action="login.php" class="form-inline">
          ...
          <span class="glyphicon glyphicon-log-out" style="background-color:#ffffff;"></span> Log out</button>
        </form>
      </nav>
      <br>
      <div class="container">
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="uni2.avif" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="uni3.avif" alt="Third slide">
    </div>
  </div>
