      ...
      <div id="accordion">
          ...
          <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
            <div class="card-body">
                  <div class="card-group">
                    <div class="card">
                      <img class="card-img-top" src="csi.jpg" alt="Card image cap">
                      <div class="card-body">
                        <h5 class="card-title">CSI</h5>
                        <form method="post" action="university.php">
                    ...
                    <div class="card">
                      <img class="card-img-top" src="ieee.png" alt="Card image cap">
                      <div class="card-body">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">BAN Be A Nerd</h5>
                        <form method="post" action="university.php">
                    ...
                    <div class="card">
                      <img class="card-img-top" src="and.png" alt="Card image cap">
                      <div class="card-body">
                        <h5 class="card-title">Android Club</h5>
                        <form method="post" action="university.php">
        ...
        <div class="card">
            ...
            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
              ...
              <div class="jumbotron">
                <h1 class="display-4">VITOPIA 2k22</h1>
                <p class="lead">This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
                <hr class="my-4">
                <p>It uses utility classes for typography and spacing to space content out within the larger container.</p>
                <p class="lead">
